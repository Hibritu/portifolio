...
export default function Experience() {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="flex items-start">
            ...
            <div className="text-white ml-4">
              ...
              <p className="text-sm text-gray-400 mb-1">February 2024 – july 2024</p>
          ...
          <div className="flex items-start">
            ...
            <div className="text-white ml-4">
              ...
              <p className="text-sm text-gray-400 mb-1">February 2024 – june 2024</p>
              <p className="text-gray-300">
  ...
  <div className="text-white ml-4">
    <h3 className="text-xl font-semibold">
      Cyber Talent Training – <span className="text-gray-300">INSA (Information Network Security Administration)</span>
    </h3>
    <p className="text-sm text-gray-400 mb-1">
      August 2024
    </p>
    <p className="text-gray-300">
      Successfully progressed to the <span className="font-medium text-white">4th round</span> of the INSA Cyber Talent Training Program. Strengthened my skills in cybersecurity fundamentals, secure software development, networking, Linux, problem-solving, teamwork, and practical programming through hands-on training and technical assessments.
    </p>
  </div>
</div>
        </div>
